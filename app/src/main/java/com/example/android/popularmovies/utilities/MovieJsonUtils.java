 ...
 **/
public static ArrayList<ItemModel> getSimpleMovieStringsFromJson(Context context, String movieJsonStr)
    ...
    for(int i=0; i<movieArray.length();i++){
        ...
        String title=object.optString(MV_ORIGINAL_TITLE);
        ...
        gridItem.setOriginalTitle(title);
        gridItem.setId(id);
